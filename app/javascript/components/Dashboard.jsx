...
*/
  const LINK_INACTIVE_CLASS_NAME =
    "flex items-center mt-5 py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100";
  const LINK_ACTIVE_CLASS_NAME =
    "flex items-center mt-5 py-2 px-8 bg-gray-700 text-gray-100 border-r-4 border-gray-100";
  //flex items-center py-2 px-8 bg-gray-700 text-gray-100 border-r-4 border-gray-100
  return (
    <>
      <div
            ...
            <div className="w-64 h-screen bg-gray-800 mt-8 sm:mt-0">
              ...
              <nav className="mt-10">
                ...
                >
                  ...
                  <span class="mx-4 font-medium">Tasks Due Today</span>
                </NavLink>
